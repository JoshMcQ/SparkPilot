...
ARG NEXT_PUBLIC_SPARKPILOT_API_PREFIX="/api/sparkpilot"
ARG NEXT_PUBLIC_MARKETING_SITE_URL="https://sparkpilot.cloud"
ARG NEXT_PUBLIC_COGNITO_IDENTITY_PROVIDER=""
...
ENV NEXT_PUBLIC_SPARKPILOT_API_PREFIX=${NEXT_PUBLIC_SPARKPILOT_API_PREFIX}
ENV NEXT_PUBLIC_MARKETING_SITE_URL=${NEXT_PUBLIC_MARKETING_SITE_URL}
ENV NEXT_PUBLIC_COGNITO_IDENTITY_PROVIDER=${NEXT_PUBLIC_COGNITO_IDENTITY_PROVIDER}
