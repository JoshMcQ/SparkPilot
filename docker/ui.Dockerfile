...
ARG NEXT_PUBLIC_INTERNAL_OIDC_ISSUER=""
ARG NEXT_PUBLIC_INTERNAL_OIDC_CLIENT_ID=""
ARG NEXT_PUBLIC_INTERNAL_OIDC_REDIRECT_URI=""
ARG NEXT_PUBLIC_INTERNAL_OIDC_AUDIENCE=""
...
ARG NEXT_PUBLIC_INTERNAL_COGNITO_IDENTITY_PROVIDER=""
...
ENV NEXT_PUBLIC_INTERNAL_OIDC_ISSUER=${NEXT_PUBLIC_INTERNAL_OIDC_ISSUER}
ENV NEXT_PUBLIC_INTERNAL_OIDC_CLIENT_ID=${NEXT_PUBLIC_INTERNAL_OIDC_CLIENT_ID}
ENV NEXT_PUBLIC_INTERNAL_OIDC_REDIRECT_URI=${NEXT_PUBLIC_INTERNAL_OIDC_REDIRECT_URI}
ENV NEXT_PUBLIC_INTERNAL_OIDC_AUDIENCE=${NEXT_PUBLIC_INTERNAL_OIDC_AUDIENCE}
...
ENV NEXT_PUBLIC_INTERNAL_COGNITO_IDENTITY_PROVIDER=${NEXT_PUBLIC_INTERNAL_COGNITO_IDENTITY_PROVIDER}
